...
class searchwindow:
    ...
    def entries(self, data):
        ...
        #self.temp = Label(self.root, text='Temperature', font=('calibri',20,'bold'),bg='#57adff')
        #self.temp.place(x=525,y=125)
    ...
    def getweather(self):
        try:
            ...
            req = 'https://api.openweathermap.org/data/2.5/weather?q=' + city + '&appid=' + self.API_KEY
